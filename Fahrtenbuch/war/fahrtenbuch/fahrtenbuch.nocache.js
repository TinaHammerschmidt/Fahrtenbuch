...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "fahrtenbuch" because\n';
  ...
  $wnd.__gwt_activeModules['fahrtenbuch'] = {
 ...
 * "/fahrtenbuch.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['fahrtenbuch'].superdevmode = true;

  var expectedSuffix = '/fahrtenbuch.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + fahrtenbuch + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:fahrtenbuch';
  var devModeSessionKey = '__gwtDevModeSession:fahrtenbuch';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/fahrtenbuch/fahrtenbuch.nocache.js';
  ...
  $wnd.__gwt_activeModules['fahrtenbuch'].canRedirect = true;
  $wnd.__gwt_activeModules['fahrtenbuch'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/fahrtenbuch?user.agent=' + ua + '&_callback=' + callback;
